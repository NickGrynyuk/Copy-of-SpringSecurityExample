...
<div class="cp">
	...
	<c:forEach var="silver" items="${silverList}" varStatus="status">
        ...
        <li>
              ...
              <div class="box-5"> <a href="indentinfo.do?name=${silver.name}&image=${silver.image}"><img src="${silver.image}"  alt=""></a>
            <div class="fc">
                  <div class="padding"> <span>Name: ${silver.name}</span>
