...
<div class="cp">
	...
	<c:forEach var="bronzes" items="${bronzesList}" varStatus="status">
        ...
        <li>
              ...
              <div class="box-5"> <a href="indentinfo.do?name=${bronzes.name}&image=${bronzes.image}"><img src="${bronzes.image}"  alt=""></a>
            <div class="fc">
                  <div class="padding"> <span>Name: ${bronzes.name}</span>
