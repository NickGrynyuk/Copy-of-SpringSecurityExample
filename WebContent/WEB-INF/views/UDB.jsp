...
<div class="cp">
	...
	<c:forEach var="client" items="${clientList}" varStatus="status">
        ...
        <li>
              ...
              <div class="box-5"> <a href="indentinfo.do?name=${client.fname}&image=${client.image}"> <img src="${client.image}"  alt=""></a>
            <div class="fc">
                  <div class="padding"> <span>Name: ${client.fname} ${client.lname}</span>
                <div class="padding"> 
                Email:  ${client.email}<br>
                Number of orders:${client.norders}
